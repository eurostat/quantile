...
put "select pB010 'Year', pB030 'PID', PL120, PL120_F, PL031,PL035,PL060,PL060_F,PL100 from dds.c%nrstr(&cc).&yy.p";
...
put " ";
put "title4 'Routing check: value must not be -2 if PL031 in (1,2,3,4) and ';";
