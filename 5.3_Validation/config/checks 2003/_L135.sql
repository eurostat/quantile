...
put "from (l%nrstr(&cc).04r as a left join l%nrstr(&cc).04r as b on a.RB030 = b.RB030 and a.RHID ne b.RHID and a.RB010 = b.RB010)";
put "left join l%nrstr(&cc).04d as c on b.RHID = c.DB030 and b.RB010 = c.DB010";
