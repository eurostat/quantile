...
*%income_percentile (&typ,&inc,&year, &weight, &cntr,&percent); 

%macro income_percentile (libin,linout,nfile,typ, inc, yyyy, weight, Ucc,percentile);

	%if "&libin"="' '" %then %do;/*lib=' '*/
		%let libin=WORK;
	%end;
	%if "&libout"="' '" %then %do;/*lib=' '*/
		%let libout=WORK;
	%end;
	%put pppp;
%put libin = &libin libout  = &libout;
	...
	%if &percentile=decile %then %do;
		...
		%let text2= (P_10={LABEL='DECILE 1'}  *F=12.0
    	  ...
    	  %let text3=(CASE 
   		  WHEN &nfile..&inc < OUTW.P_10 THEN "DECILE1" 
		  WHEN &nfile..&inc < OUTW.P_20 THEN "DECILE2" 
		  WHEN &nfile..&inc < OUTW.P_30 THEN "DECILE3" 
   		  WHEN &nfile..&inc < OUTW.P_40 THEN "DECILE4" 
   		  WHEN &nfile..&inc < OUTW.P_50 THEN "DECILE5" 
   		  WHEN &nfile..&inc < OUTW.P_60 THEN "DECILE6" 
  		  WHEN &nfile..&inc < OUTW.P_70 THEN "DECILE7" 
  		  WHEN &nfile..&inc < OUTW.P_80 THEN "DECILE8" 
  		  WHEN &nfile..&inc < OUTW.P_90 THEN "DECILE9" 
   		  ELSE  "DECILE10" 
		  END ) AS DECILE;
     %end;
	 ...
	 %let text1=QUINTILE;
 	 ...
 	 %let text3=(CASE 
   		WHEN &nfile..&inc < OUTW.P_20 THEN "QUINTILE1" 
   		WHEN &nfile..&inc < OUTW.P_40 THEN "QUINTILE2"
   		WHEN &nfile..&inc < OUTW.P_60 THEN "QUINTILE3" 		
  		WHEN &nfile..&inc < OUTW.P_80 THEN "QUINTILE4" 
   		ELSE "QUINTILE5" 
		END ) AS QUINTILE;
	%end;
    ...
    %let text3=(CASE 
   		WHEN &nfile..&inc < OUTW.P_25 THEN "QUARTILE1" 
   		WHEN &nfile..&inc < OUTW.P_50 THEN "QUARTILE2" 
   		WHEN &nfile..&inc < OUTW.P_75 THEN "QUARTILE3" 		
   		ELSE "QUARTILE4" 
		END ) AS QUARTILE;
   %end; 
	...
	P_94={LABEL='PERCENTILE 94'}  *F=12.0 
		  ...
		  P_99={LABEL='PERCENTILE 99'}  *F=12.0 
 		  P_100={LABEL='PERCENTILE 100'}  *F=12.0)
			;
	  %let text3=(CASE 
   		WHEN &nfile..&inc < OUTW.P_1 THEN "PERCENTILE1" 
   		WHEN &nfile..&inc < OUTW.P_2 THEN "PERCENTILE2" 
   		WHEN &nfile..&inc < OUTW.P_3 THEN "PERCENTILE3" 	
		WHEN &nfile..&inc < OUTW.P_4 THEN "PERCENTILE4" 	
		WHEN &nfile..&inc < OUTW.P_5 THEN "PERCENTILE5" 
		WHEN &nfile..&inc < OUTW.P_5 THEN "PERCENTILE5" 
		WHEN &nfile..&inc < OUTW.P_6 THEN "PERCENTILE6" 
		WHEN &nfile..&inc < OUTW.P_7 THEN "PERCENTILE7" 
		WHEN &nfile..&inc < OUTW.P_8 THEN "PERCENTILE8" 
		WHEN &nfile..&inc < OUTW.P_9 THEN "PERCENTILE9" 
		WHEN &nfile..&inc < OUTW.P_10 THEN "PERCENTILE10" 
		WHEN &nfile..&inc < OUTW.P_11 THEN "PERCENTILE11" 
		WHEN &nfile..&inc < OUTW.P_12 THEN "PERCENTILE12" 
		WHEN &nfile..&inc < OUTW.P_13 THEN "PERCENTILE13" 
		WHEN &nfile..&inc < OUTW.P_14 THEN "PERCENTILE14" 
		WHEN &nfile..&inc < OUTW.P_15 THEN "PERCENTILE15" 
		WHEN &nfile..&inc < OUTW.P_16 THEN "PERCENTILE16" 
		WHEN &nfile..&inc < OUTW.P_17 THEN "PERCENTILE17" 
		WHEN &nfile..&inc < OUTW.P_18 THEN "PERCENTILE18" 
		WHEN &nfile..&inc < OUTW.P_19 THEN "PERCENTILE19" 
		WHEN &nfile..&inc < OUTW.P_20 THEN "PERCENTILE20" 
		WHEN &nfile..&inc < OUTW.P_21 THEN "PERCENTILE21" 
		WHEN &nfile..&inc < OUTW.P_22 THEN "PERCENTILE22" 
		WHEN &nfile..&inc < OUTW.P_23 THEN "PERCENTILE23" 
		WHEN &nfile..&inc < OUTW.P_24 THEN "PERCENTILE24" 
		WHEN &nfile..&inc < OUTW.P_25 THEN "PERCENTILE25" 
		WHEN &nfile..&inc < OUTW.P_26 THEN "PERCENTILE26" 
		WHEN &nfile..&inc < OUTW.P_27 THEN "PERCENTILE27" 
		WHEN &nfile..&inc < OUTW.P_28 THEN "PERCENTILE28" 
		WHEN &nfile..&inc < OUTW.P_29 THEN "PERCENTILE29" 
		WHEN &nfile..&inc < OUTW.P_30 THEN "PERCENTILE30" 
		WHEN &nfile..&inc < OUTW.P_31 THEN "PERCENTILE31" 
		WHEN &nfile..&inc < OUTW.P_32 THEN "PERCENTILE32" 
		WHEN &nfile..&inc < OUTW.P_33 THEN "PERCENTILE33" 
		WHEN &nfile..&inc < OUTW.P_34 THEN "PERCENTILE34" 
		WHEN &nfile..&inc < OUTW.P_35 THEN "PERCENTILE35" 
		WHEN &nfile..&inc < OUTW.P_36 THEN "PERCENTILE36" 
		WHEN &nfile..&inc < OUTW.P_37 THEN "PERCENTILE37" 
		WHEN &nfile..&inc < OUTW.P_38 THEN "PERCENTILE38" 
		WHEN &nfile..&inc < OUTW.P_39 THEN "PERCENTILE39" 
		WHEN &nfile..&inc < OUTW.P_40 THEN "PERCENTILE40" 
		WHEN &nfile..&inc < OUTW.P_41 THEN "PERCENTILE41" 
		WHEN &nfile..&inc < OUTW.P_42 THEN "PERCENTILE42" 
		WHEN &nfile..&inc < OUTW.P_43 THEN "PERCENTILE43" 
		WHEN &nfile..&inc < OUTW.P_44 THEN "PERCENTILE44" 
		WHEN &nfile..&inc < OUTW.P_45 THEN "PERCENTILE45" 
		WHEN &nfile..&inc < OUTW.P_46 THEN "PERCENTILE46" 
		WHEN &nfile..&inc < OUTW.P_47 THEN "PERCENTILE47" 
		WHEN &nfile..&inc < OUTW.P_48 THEN "PERCENTILE48" 
		WHEN &nfile..&inc < OUTW.P_49 THEN "PERCENTILE49" 
		WHEN &nfile..&inc < OUTW.P_50 THEN "PERCENTILE50" 
		WHEN &nfile..&inc < OUTW.P_51 THEN "PERCENTILE51" 
		WHEN &nfile..&inc < OUTW.P_52 THEN "PERCENTILE52" 
		WHEN &nfile..&inc < OUTW.P_53 THEN "PERCENTILE53" 
		WHEN &nfile..&inc < OUTW.P_54 THEN "PERCENTILE54" 
		WHEN &nfile..&inc < OUTW.P_55 THEN "PERCENTILE55" 
		WHEN &nfile..&inc < OUTW.P_56 THEN "PERCENTILE56" 
		WHEN &nfile..&inc < OUTW.P_57 THEN "PERCENTILE57" 
		WHEN &nfile..&inc < OUTW.P_58 THEN "PERCENTILE58" 
		WHEN &nfile..&inc < OUTW.P_59 THEN "PERCENTILE59" 
		WHEN &nfile..&inc < OUTW.P_60 THEN "PERCENTILE60" 
		WHEN &nfile..&inc < OUTW.P_61 THEN "PERCENTILE61" 
		WHEN &nfile..&inc < OUTW.P_62 THEN "PERCENTILE62" 
		WHEN &nfile..&inc < OUTW.P_63 THEN "PERCENTILE63" 
		WHEN &nfile..&inc < OUTW.P_64 THEN "PERCENTILE64" 
		WHEN &nfile..&inc < OUTW.P_65 THEN "PERCENTILE65" 
		WHEN &nfile..&inc < OUTW.P_66 THEN "PERCENTILE66" 
		WHEN &nfile..&inc < OUTW.P_67 THEN "PERCENTILE67" 
		WHEN &nfile..&inc < OUTW.P_68 THEN "PERCENTILE68" 
		WHEN &nfile..&inc < OUTW.P_69 THEN "PERCENTILE69" 
		WHEN &nfile..&inc < OUTW.P_70 THEN "PERCENTILE70" 
		WHEN &nfile..&inc < OUTW.P_71 THEN "PERCENTILE71" 
		WHEN &nfile..&inc < OUTW.P_72 THEN "PERCENTILE72" 
		WHEN &nfile..&inc < OUTW.P_73 THEN "PERCENTILE73" 
		WHEN &nfile..&inc < OUTW.P_74 THEN "PERCENTILE74" 
		WHEN &nfile..&inc < OUTW.P_75 THEN "PERCENTILE75" 
		WHEN &nfile..&inc < OUTW.P_76 THEN "PERCENTILE76" 
		WHEN &nfile..&inc < OUTW.P_77 THEN "PERCENTILE77" 
		WHEN &nfile..&inc < OUTW.P_78 THEN "PERCENTILE78" 
		WHEN &nfile..&inc < OUTW.P_79 THEN "PERCENTILE79" 
		WHEN &nfile..&inc < OUTW.P_80 THEN "PERCENTILE80" 
		WHEN &nfile..&inc < OUTW.P_81 THEN "PERCENTILE81" 
		WHEN &nfile..&inc < OUTW.P_82 THEN "PERCENTILE82" 
		WHEN &nfile..&inc < OUTW.P_83 THEN "PERCENTILE83" 
		WHEN &nfile..&inc < OUTW.P_84 THEN "PERCENTILE84" 
		WHEN &nfile..&inc < OUTW.P_85 THEN "PERCENTILE85" 
		WHEN &nfile..&inc < OUTW.P_86 THEN "PERCENTILE86" 
		WHEN &nfile..&inc < OUTW.P_87 THEN "PERCENTILE87" 
		WHEN &nfile..&inc < OUTW.P_88 THEN "PERCENTILE88" 
		WHEN &nfile..&inc < OUTW.P_89 THEN "PERCENTILE89" 
		WHEN &nfile..&inc < OUTW.P_90 THEN "PERCENTILE90" 
		WHEN &nfile..&inc < OUTW.P_91 THEN "PERCENTILE91" 
		WHEN &nfile..&inc < OUTW.P_92 THEN "PERCENTILE92" 
		WHEN &nfile..&inc < OUTW.P_93 THEN "PERCENTILE93" 
		WHEN &nfile..&inc < OUTW.P_94 THEN "PERCENTILE94" 
		WHEN &nfile..&inc < OUTW.P_95 THEN "PERCENTILE95" 
		WHEN &nfile..&inc < OUTW.P_96 THEN "PERCENTILE96" 
   		WHEN &nfile..&inc < OUTW.P_97 THEN "PERCENTILE97" 
   		WHEN &nfile..&inc < OUTW.P_98 THEN "PERCENTILE98" 	
		WHEN &nfile..&inc < OUTW.P_99 THEN "PERCENTILE99" 
			ELSE "PERCENTILE100" 
		END ) AS PERCENTILE;
     %end;
/* to calculte the Quantiles  */
PROC UNIVARIATE DATA=&nfile NOPRINT;
  VAR &inc;
  CLASS COUNTRY;
  WEIGHT &weight; 
...
data &nfile.2(drop=_TYPE_  _PAGE_  _TABLE_); set  &nfile.2;
	TIME="&yyyy";CURRENCY="&typ";IFLAG="";
run;

  data &nfile.2;set &nfile.2(drop=Country);
  GEO="&Ucc";run;
...
%if  &percentile=quintile %then %do;
	...
	%let text14=&text1.4;
	%let text15=&text1.5;
	Data &nfile.2(rename=(P_20_SUM=&text11 P_40_SUM=&text12 P_60_SUM=&text13 P_80_SUM=&text14 P_100_SUM=&text15));
...
%if  &percentile=quartile %then %do;
	...
	Data &nfile.2(rename=(P_25_SUM=&text11 P_50_SUM=&text12 P_75_SUM=&text13 P_100_SUM=&text14));
...
PROC SQL;
     CREATE TABLE WORK.&nfile.1 AS
  	 SELECT &nfile..*, 
	 &text3  ,
		(CASE WHEN CALCULATED &text1 is missing THEN -1 ELSE 1 END) AS &text1._F
 	 FROM WORK.&nfile. INNER JOIN WORK.OUTW ON &nfile..COUNTRY = OUTW.COUNTRY;
QUIT;
/* to  calculate  frequencies, cumulative  frequencies and weights and income */
proc sort data=&nfile.1; by country &percentile &inc;run;
PROC MEANS data=&nfile.1 median sumwgt qmethod=os noprint;  
	var &inc;
...
%if ( &percentile=percentile or &percentile=decile ) %then %do;
	...
	quit;
	%end;
data &nfile.3(rename =(perc100=&percentile));set perc_100x(drop=&percentile);run;
%end;
...
data pp(drop=_freq_ _type_);set pp;run;
	data &nfile.3; merge &nfile.3 pp; by country;
run;
...
run;*/
%mend income_percentile;
%let yyyy=2013;
%let cntr=AT;
%let MS=0;
%let flag="";
%let percent=percentile;
%let weight=RB050a;
%let typ=eur;
%let inc=eq_inc20;
%let nfile=idb;
...
%income_percentile ('','',&nfile,&typ,&inc,&yyyy, &weight, &cntr,&percent); 
%let libin= work;
%let pp=&libin..&nfile;
