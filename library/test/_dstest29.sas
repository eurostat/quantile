...
%macro _dstest29(lib=, _ds_=, verb=no, force=no);
 	%local _dsn _ilib;
...
%macro _example_dstest29;
	...
	%_dstest29(lib=WORK);
	%put Test dataset is generated in WORK library as: _dstest29;
	%ds_print(_dstest29);

	%work_clean(_dstest29);
%mend _example_dstest29;
