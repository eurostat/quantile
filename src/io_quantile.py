...
class Quantile(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.__params = None
        # set default values
        self.__probs = quantile.DEF_PROBS
        self.__typ = quantile.DEF_TYPE
        self.__method = quantile.DEF_METHOD 
        self.__limit = quantile.DEF_LIMIT
        self.__na_rm = quantile.DEF_NARM
        if kwargs == {}:
            return
    ...
    def __call__(self, data, **kwargs):  
        ...
        self.__quantile = quantile.quantile(data, self.probs, **kwargs)
        return self.__quantile
